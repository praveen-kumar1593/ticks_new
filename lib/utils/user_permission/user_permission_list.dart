const List<Map<String, dynamic>> userPermissionsList = [
  {
  ...
  },
  {
    ...
    "features": [
      ...
      },
      {
        ...
        "accessCode": "oajF",
        "permissions": [
          {"name": "view", "accessCode": "zawd"},
          {"name": "update", "accessCode": "yZok"},
        ],
      },
    ],
  },
    ...
    "features": [
      {
        ...
        "permissions": [
          ...
          {"name": "deleteAttachment", "accessCode": "cjbe"},
        ],
      },
      {
        "name": "jobInsights",
    ...
    "features": [
      {
        ...
        "permissions": [
          ...
          {"name": "deleteAttachment", "accessCode": "kPba"},
        ],
      },
      {
    ...
    "features": [
      {
        ...
        "accessCode": "GpKO",
        "permissions": [
          {"name": "list", "accessCode": "tuMN"},
          {"name": "view", "accessCode": "ogdn"},
          {"name": "create", "accessCode": "uoTz"},
          {"name": "update", "accessCode": "Rrfq"},
          {"name": "delete", "accessCode": "jXVm"},
        ],
      },
      {
        "name": "contracts",
        "accessCode": "tpRR",
        "permissions": [
          {"name": "list", "accessCode": "Spac"},
          {"name": "view", "accessCode": "jYSt"},
          {"name": "create", "accessCode": "gJYm"},
          {"name": "update", "accessCode": "UWET"},
          {"name": "delete", "accessCode": "UZMO"},
        ],
      },
      {
        "name": "moveInOut",
        "accessCode": "OhnX",
        "permissions": [
          {"name": "list", "accessCode": "wbdF"},
          {"name": "view", "accessCode": "iJIo"},
          {"name": "create", "accessCode": "mhcb"},
          {"name": "update", "accessCode": "ATJB"},
          {"name": "delete", "accessCode": "ZzQs"},
        ],
      },
    ],
  },
    ...
    "features": [
      {
        ...
        "accessCode": "ZIDe",
        "permissions": [
          {"name": "list", "accessCode": "mzSs"},
          {"name": "view", "accessCode": "GnHN"},
          {"name": "create", "accessCode": "DTUj"},
          {"name": "update", "accessCode": "AlaN"},
          {"name": "delete", "accessCode": "fiOZ"},
          {"name": "scan", "accessCode": "kwSw"},
        ],
      },
      {
        ...
        "accessCode": "bRLQ",
        "permissions": [
          {"name": "list", "accessCode": "rxKg"},
          {"name": "view", "accessCode": "wrFt"},
          {"name": "create", "accessCode": "hIJH"},
          {"name": "update", "accessCode": "rcbl"},
          {"name": "delete", "accessCode": "Cebr"},
        ],
      },
    ],
  },
    ...
    "features": [
      {
        ...
        "accessCode": "fuVd",
        "permissions": [
          {"name": "individualMarking", "accessCode": "fRcG"},
          {"name": "teamsMarking", "accessCode": "FLJQ"},
        ],
      },
      {
      ...
      },
      {
        ...
        "accessCode": "yokz",
        "permissions": [
          {"name": "configureUsers", "accessCode": "ltAC"},
          {"name": "configureShifts", "accessCode": "YCsb"},
          {"name": "configureGeofence", "accessCode": "vKvP"},
        ],
      },
    ],
  },
